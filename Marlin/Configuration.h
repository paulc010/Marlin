...
#define STRING_CONFIG_H_AUTHOR "(paulc010, v2.01 Test)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BIGTREE_SKR_V1_3 // MOTHERBOARD BOARD_RAMPS_14_SF
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.25 }
